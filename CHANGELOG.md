...
## [v3.2.16](https://github.com/chef/mixlib-log/tree/v3.2.16) (2026-06-21)

#### Merged Pull Requests
- Bump actions/checkout from 6 to 7 [#102](https://github.com/chef/mixlib-log/pull/102) ([dependabot[bot]](https://github.com/dependabot[bot]))
<!-- latest_release -->
...
#### Merged Pull Requests
- Bump actions/checkout from 6 to 7 [#102](https://github.com/chef/mixlib-log/pull/102) ([dependabot[bot]](https://github.com/dependabot[bot])) <!-- 3.2.16 -->
- Bump wechuli/allcheckspassed from 1 to 2 [#101](https://github.com/chef/mixlib-log/pull/101) ([dependabot[bot]](https://github.com/dependabot[bot])) <!-- 3.2.15 -->
